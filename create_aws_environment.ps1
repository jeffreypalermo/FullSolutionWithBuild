...
# }
 ...
 aws cloudformation create-stack --region "us-east-1" --stack-name "ClearMeasureBootcamp" --template-body https://s3.amazonaws.com/cm-projectbootcamp/cloud_formation/BootCamp.template --parameters https://s3.amazonaws.com/cm-projectbootcamp/cloud_formation/cf_parameters.json 
